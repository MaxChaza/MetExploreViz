...
var metExploreViz = function(panel, webSite){
    ...
    this.panel = panel;
    this.linkStyle = new LinkStyle(35, 2, 5, 5, 'red', 'green', 'black', '0.7', 'black');
    ...
    this.generalStyle = new GeneralStyle("Website", "yellow", "blue", 500, false, false, false, false, false, 0.4);
